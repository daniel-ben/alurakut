...
import OrkutNostalgicIconSetList from '../components/NostalgicIconSet'
...
export function OrkutNostalgicIconSet(props) {
  return (
    <OrkutNostalgicIconSetList>
      ...
      {[
        { name: 'Confiável', slug: 'confiavel', icon: 'smile', value: 3 },
        { name: 'Legal', slug: 'legal', icon: 'cool', value: 3 },
        { name: 'Sexy', slug: 'sexy', icon: 'heart', value: 1 },
